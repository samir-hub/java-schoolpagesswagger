...
public class Student
{
    ...
    @ApiModelProperty(name = "studname", value = "name of Student", example = "Bobby Perez")
    private String studname;

    @ApiModelProperty(name = "courses", value = "courses that Student is in", example = "Data Science")
    @ManyToMany
