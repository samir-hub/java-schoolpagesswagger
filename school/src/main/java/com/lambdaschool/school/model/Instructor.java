...
public class Instructor
{
    ...
    @ApiModelProperty(name = "instructname", value = "name of Instructor", example = "Bobby Perez")
    private String instructname;

    @ApiModelProperty(name = "courses", value = "courses that Instructor teaches", example = "Data Science")
